   ...
   <div class="row">
    <div class="col-md-2">
     ...
     <ul class="list-group list-group-flush">
      ...
      <a href="{{ route('change.password') }}" class="btn btn-primary btn-block btn-sm ">Chamge Password</a>
    ...
    <div class="col-md-6">
     <div class="card">
      <h3 class="text-center">Hi...<span class="text-danger">{{ Auth::user()->name }} Welcome to this market </span>
      </h3>
     </div>
    </div>
   </div>
