   ...
   <div class="row">
    ...
    <div class="col-md-2">
     ...
     <ul class="list-group list-group-flush">
      ...
      <a href="{{ route('change.passsword') }}" class="btn btn-primary btn-block btn-sm ">Chamge Password</a>
      <a href="{{ route('user.logout') }}" class="btn btn-danger btn-block btn-sm ">Logout</a>
     </ul>
    </div>
    <div class="col-md-6">
     <div class="card">
      <h3 class="text-center"><span class="text-danger">Hi....</span><strong>{{ Auth::user()->name }}</strong> Update
       Your Profile </h3>
